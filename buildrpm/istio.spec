...
# out when the envoy binary is not available
%if "%{dist}" == ".el8"
...
%changelog
* Fri Jun 05 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.30.1-1
- Added Oracle specific files for 1.30.1-1
