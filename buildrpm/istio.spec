...
# Move envoy to where istio expects it to be when available.
%if "%{dist}" == ".el8"
...
%changelog
* Fri Jun 05 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.28.8-1
- Added Oracle specific files for 1.28.8-1
